...
var PDFViewerApplication = {
  ...
  info: function pdfViewInfo(message) {
    document.getElementsByClassName('toolbar')[0].setAttribute('hidden', 'true');
    var errorWrapperConfig = this.appConfig.errorWrapper;
    var errorWrapper = errorWrapperConfig.container;
    errorWrapper.removeAttribute('hidden');
    ...
    errorWrapper.setAttribute('style', 'position: absolute; top: 40px; background: none; padding: 0; width: 100%; text-align: center; font-size: 17px; color: #555;');
